...
# 手动安装必要依赖
pip install decorator ipython python-dateutil pygments
```
...
# 安装"最后一版"无JupyterLab依赖的经典笔记本 (2020年版本)
`pip install notebook==5.7.12 ipykernel==5.5.5 tornado==6.0.4`
