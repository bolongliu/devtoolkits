...
# 修复配置文件
mkdir -p ~/.jupyter
echo "c.ServerApp.jpserver_extensions = {'nbclassic': True}" > ~/.jupyter/jupyter_notebook_config.py
echo "c.NotebookApp.default_url = '/tree'" >> ~/.jupyter/jupyter_notebook_config.py
